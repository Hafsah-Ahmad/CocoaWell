...
const INITIAL_REMINDERS = [
  {
    ...
    icon: <MaterialCommunityIcons name="pill" size={20} color={COLORS.primary} />,
    enabled: true,
  },
  {
    id: 'water',
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerTitle}>
          spa <Text style={styles.headerTitleBold}>Cocoa Well</Text>
        </Text>
        <Image
      ...
      >
        ...
        {reminders.map((reminder) => (
          <View key={reminder.id} style={styles.reminderCard}>
            <View style={styles.reminderIconWrap}>{reminder.icon}</View>
