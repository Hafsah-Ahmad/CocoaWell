...
const PreferenceRow: React.FC<PreferenceRowProps> = ({ icon, iconBg, title, subtitle, onPress }) => (
...
export default function ProfileScreen() {
  ...
  const displayName: string = profile?.full_name || MOCK_USER.name;
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue}>{profile?.full_name || MOCK_USER.name}</Text>
          </View>
          <View style={styles.divider} />
          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Age</Text>
            <Text style={styles.detailValue}>
              {profile?.age ? `${profile.age} Years` : MOCK_USER.age}
            </Text>
          </View>
          <View style={styles.divider} />
          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Email</Text>
            <Text style={styles.detailValue}>{user?.email || MOCK_USER.email}</Text>
          </View>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.statsRow}>
            <View style={styles.statBox}>
              ...
              <Text style={styles.statValue}>
                {profile?.height ? `${profile.height} cm` : MOCK_USER.height}
              </Text>
            </View>
            <View style={styles.statBox}>
              <Text style={styles.statLabel}>Weight</Text>
              <Text style={styles.statValue}>
                {profile?.weight ? `${profile.weight} kg` : MOCK_USER.weight}
              </Text>
            </View>
          </View>
          ...
          <View style={styles.fullStatBox}>
            ...
            <Text style={styles.statValue}>{profile?.activity_level || MOCK_USER.activityLevel}</Text>
          </View>

          <View style={styles.goalBox}>
            <Text style={styles.goalLabel}>Primary Wellness Goal</Text>
            <Text style={styles.statValue}>{profile?.primary_goal || MOCK_USER.primaryGoal}</Text>
          </View>
        </View>
        ...
        {/* Action Buttons */}
        <TouchableOpacity style={styles.editProfileButton} activeOpacity={0.85} onPress={() => router.push('/profile-setup' as any)}>
          <Text style={styles.editProfileButtonText}>Edit Profile</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.privacyButton} activeOpacity={0.85} onPress={() => router.push('/settings' as any)}>
